...
@Component({
  selector: 'AnalystRating-home',
  templateUrl: './AnalystRating-home.component.html',
  styleUrls: ['./AnalystRating-home.component.scss']
})
export class AnalystRatingHomeComponent implements AfterViewInit {
