...
@Component({
  selector: 'Dividend-home',
  templateUrl: './Dividend-home.component.html',
  styleUrls: ['./Dividend-home.component.scss']
})
export class DividendHomeComponent implements AfterViewInit {
