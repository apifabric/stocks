...
@Component({
  selector: 'FinancialReport-home',
  templateUrl: './FinancialReport-home.component.html',
  styleUrls: ['./FinancialReport-home.component.scss']
})
export class FinancialReportHomeComponent implements AfterViewInit {
