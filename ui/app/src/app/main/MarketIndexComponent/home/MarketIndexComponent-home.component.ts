...
@Component({
  selector: 'MarketIndexComponent-home',
  templateUrl: './MarketIndexComponent-home.component.html',
  styleUrls: ['./MarketIndexComponent-home.component.scss']
})
export class MarketIndexComponentHomeComponent implements AfterViewInit {
