...
@Component({
  selector: 'MarketIndice-home',
  templateUrl: './MarketIndice-home.component.html',
  styleUrls: ['./MarketIndice-home.component.scss']
})
export class MarketIndiceHomeComponent implements AfterViewInit {
