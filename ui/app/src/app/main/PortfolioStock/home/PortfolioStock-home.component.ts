...
@Component({
  selector: 'PortfolioStock-home',
  templateUrl: './PortfolioStock-home.component.html',
  styleUrls: ['./PortfolioStock-home.component.scss']
})
export class PortfolioStockHomeComponent implements AfterViewInit {
