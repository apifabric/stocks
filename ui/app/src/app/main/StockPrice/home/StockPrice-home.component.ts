...
@Component({
  selector: 'StockPrice-home',
  templateUrl: './StockPrice-home.component.html',
  styleUrls: ['./StockPrice-home.component.scss']
})
export class StockPriceHomeComponent implements AfterViewInit {
