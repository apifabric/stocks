...
@Component({
  selector: 'StockVolume-home',
  templateUrl: './StockVolume-home.component.html',
  styleUrls: ['./StockVolume-home.component.scss']
})
export class StockVolumeHomeComponent implements AfterViewInit {
