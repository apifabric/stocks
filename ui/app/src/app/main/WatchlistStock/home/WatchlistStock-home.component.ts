...
@Component({
  selector: 'WatchlistStock-home',
  templateUrl: './WatchlistStock-home.component.html',
  styleUrls: ['./WatchlistStock-home.component.scss']
})
export class WatchlistStockHomeComponent implements AfterViewInit {
